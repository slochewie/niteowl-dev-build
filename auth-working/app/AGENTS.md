...
tanstackIntent:
  ...
  - id: "@tanstack/db#db-core/collection-setup"
    run: "npx @tanstack/intent@latest load @tanstack/db#db-core/collection-setup"
  ...
  - id: "@tanstack/db#db-core/custom-adapter"
    run: "npx @tanstack/intent@latest load @tanstack/db#db-core/custom-adapter"
  ...
  - id: "@tanstack/db#db-core/live-queries"
    run: "npx @tanstack/intent@latest load @tanstack/db#db-core/live-queries"
  ...
  - id: "@tanstack/db#db-core/mutations-optimistic"
    run: "npx @tanstack/intent@latest load @tanstack/db#db-core/mutations-optimistic"
  ...
  - id: "@tanstack/db#db-core/persistence"
    run: "npx @tanstack/intent@latest load @tanstack/db#db-core/persistence"
  ...
  - id: "@tanstack/db#meta-framework"
    run: "npx @tanstack/intent@latest load @tanstack/db#meta-framework"
  ...
  - id: "@tanstack/react-db#react-db"
    run: "npx @tanstack/intent@latest load @tanstack/react-db#react-db"
