...
import { l as usePluginOverrides, C as ComposedRoute, o as authViewPaths } from "./router-qu_5GP1h.mjs";
...
var AcceptInvitationPageInternal = lazy(
  () => import("./accept-invitation-page.internal-5RS4QNQO-DS4W6CGb.mjs").then((m) => ({
