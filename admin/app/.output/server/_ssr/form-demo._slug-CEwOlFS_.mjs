...
import { R as Route$3, g as getOrCreateQueryClient } from "./router-IZBe-lk7.mjs";
import "../_libs/pg.mjs";
import { t as CircleAlert, L as LoaderCircle } from "../_libs/lucide-react.mjs";
...
import "@btst/stack/plugins/ui-builder/client";
...
function FormDemoPage() {
  ...
  const [queryClient] = reactExports.useState(() => getOrCreateQueryClient());
  const baseURL = getBaseURL();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(StackProvider, { basePath: "", overrides: {
    "form-builder": {
      apiBaseURL: baseURL,
      ...
      Link: ({
        ...
        to,
        ...props
      }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: href || to || "#", ...props })
    }
  }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "container mx-auto px-4 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card rounded-lg border p-6 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FormRenderer, { slug, onSuccess: (submission) => {
...
function FormLoadingState() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-12 gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-8 w-8 animate-spin text-muted-foreground" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Loading form..." })
  ] });
}
function FormErrorState({
  error
}) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-12 gap-4 text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-12 w-12 text-destructive" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-lg", children: "Form not found" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: error.message || "The form you're looking for doesn't exist or is no longer available." })
    ] })
  ] });
}
export {
