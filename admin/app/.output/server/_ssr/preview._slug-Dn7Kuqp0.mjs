...
import { c as Route$1, g as getOrCreateQueryClient } from "./router-IZBe-lk7.mjs";
import "../_libs/pg.mjs";
...
function PreviewPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(StackProvider, { basePath: "/preview", overrides: {
    "ui-builder": {
      apiBaseURL: baseURL,
  ...
  }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PageRenderer, { slug, componentRegistry: defaultComponentRegistry, className: "w-full", NotFoundComponent: () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center min-h-[400px] text-center p-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold mb-2", children: "Page Not Found" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground mb-4", children: [
      "The page “",
      slug,
      "” does not exist."
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/pages/ui-builder", className: "text-primary hover:underline", children: "Go to UI Builder" })
  ] }), ErrorComponent: ({
    error
  }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center min-h-[400px] text-center p-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-destructive mb-2", children: "Error" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: error instanceof Error ? error.message : String(error) })
  ] }) }) }) }) });
}
export {
