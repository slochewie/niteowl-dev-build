...
import React__default, { useState, useCallback, useMemo, useEffect, useRef, useLayoutEffect, memo, forwardRef, createElement, useContext, useImperativeHandle, createContext } from "react";
import { l as usePluginOverrides, D as useBasePath, B as Button, q as cn$1, v as Card, x as CardHeader, y as CardTitle, w as CardContent, Z as buttonVariants } from "./router-qu_5GP1h.mjs";
...
import { u as useLayerStore, d as defaultComponentRegistry, a as useEditorStore, b as addDefaultValues, c as baseColors, h as hasLayerChildren, i as isDeepEqual, f as findAllParentLayersRecursive, D as DevProfiler, A as AddComponentsPopover, e as useStore$1, t as toKeyboardShortcut, g as useKeyboardShortcuts, T as TAILWIND_V4_COLOR_KEYS, j as useGlobalLayerActions, k as canComponentAcceptChildren, l as isVariableReference, r as resolveVariableReferences, m as generateFieldOverrides, n as DndContextStateContext, C as ComponentDragContext, o as useComponentDragContext, p as countLayers, R as ResizableWrapper, q as AutoFrame, L as LayerRenderer, s as TransformWrapper, v as TransformComponent, S as SHORTCUTS, w as CodePanel, x as canLayerAcceptChildren, y as useDndContext, z as useFrame, B as useFloating, E as useControls, F as canPasteLayer } from "./registry-CU-mV0Xp.mjs";
import { D as DropdownMenu, a as DropdownMenuTrigger, b as DropdownMenuContent, c as DropdownMenuItem, d as DropdownMenuSeparator } from "./dropdown-menu-EQQ6qBjO.mjs";
import { D as DndContext, u as useSensors, a as useSensor, T as TouchSensor, d as MouseSensor, b as DragOverlay, p as pointerWithin, r as rectIntersection } from "./core.esm-Bjw07ll7.mjs";
import { createPortal } from "react-dom";
import { c as TooltipProvider, d as Toggle, T as Tooltip, a as TooltipTrigger, b as TooltipContent } from "./minimal-tiptap-C14rUPAr.mjs";
import { p as offset, t as flip, q as shift, r as limitShift } from "./Combination-C2ce2hnQ.mjs";
import { A as AutoForm, g as getBaseType } from "./index-zHebWDbP.mjs";
import { D as Dialog, e as DialogTrigger, a as DialogHeader, b as DialogTitle, h as DialogPortal, i as DialogOverlay, d as DialogContent, f as DialogClose } from "./dialog-B4u5EdHX.mjs";
import { e as Command, a as CommandInput, b as CommandList, c as CommandEmpty, g as CommandSeparator, f as CommandGroup, d as CommandItem, h as CommandShortcut } from "./command-8DCQ5FSU.mjs";
...
import { d as useSuspenseUIBuilderPage, e as useCreateUIBuilderPage, f as useUpdateUIBuilderPage, a as uiBuilderLocalization } from "./index-C9QBiYz9.mjs";
...
import { Y as Save, A as ArrowLeft, _ as Settings2, L as LoaderCircle, a5 as OctagonX, a6 as TriangleAlert, a7 as Info, a8 as CircleCheck, P as Plus, f as Check, X as X$1, a9 as Pen, k as Trash2, aa as PanelLeft, ab as PanelRight, G as GripVertical, ac as Sun, ad as Moon, a as ChevronDown, d as ChevronRight, E as EllipsisVertical, ae as CirclePlus, af as Maximize, ag as Monitor, ah as Tablet, ai as Smartphone, aj as Undo, ak as Redo, p as Eye, al as FileUp, am as ZoomIn, an as ZoomOut, ao as Crosshair, ap as MousePointer, g as Copy, aq as Scissors, ar as ClipboardPaste, as as CopyPlus, w as Trash } from "../_libs/lucide-react.mjs";
...
function DividerControl({
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn$1("relative py-0", className), children: [
      ...
      AddComponentsPopover,
      {
        ...
        children: /* @__PURE__ */ jsxs(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ jsx(CirclePlus, { className: "h-5 w-5 text-secondary-foreground" }),
              /* @__PURE__ */ jsx("span", { className: "sr-only", children: "Add component" }),
              /* @__PURE__ */ jsx("span", { className: cn$1("overflow-hidden max-w-0 group-hover:max-w-xs transition-all duration-200 ease-in-out group-hover:pl-2", popoverOpen ? "max-w-xs pl-2" : "max-w-0"), children: "Add component" })
            ]
          }
        )
      }
...
const EditorPanelContent = ({
  ...
  const autoFrameProps = useMemo(() => ({
    ...
    className: cn$1("shadow-lg", widthClass, heightClass),
    pointerEventsEnabled
  ...
  const renderer = useMemo(
    () => /* @__PURE__ */ jsx(ResizableWrapper, { ...resizableProps, children: /* @__PURE__ */ jsx(
      "div",
      {
        ...
        className: cn$1("overflow-visible ", widthClass),
              ...
              /* @__PURE__ */ jsx(
                TransformComponent,
                {
                  ...
                  children: /* @__PURE__ */ jsx(
                    "div",
                    {
                      className: cn$1("relative", widthClass),
...
function PagesPopover() {
  ...
  const textInputForm = /* @__PURE__ */ jsx("form", { className: "w-full", onSubmit: handleSubmit, children: /* @__PURE__ */ jsxs("div", { className: "w-full flex items-center space-x-2", children: [
    ...
    /* @__PURE__ */ jsx(Button, { type: "submit", variant: "secondary", children: /* @__PURE__ */ jsx(Plus, { className: "w-4 h-4" }) })
  ] }) });
...
const PageItem = ({
  ...
  return /* @__PURE__ */ jsxs(
    CommandItem,
    {
      value: page.name,
      onSelect: handleSelect,
      className: cn$1(selectedPageId === page.id && "font-bold"),
      children: [
        selectedPageId === page.id ? /* @__PURE__ */ jsx(Check, { className: "w-4 h-4 mr-2" }) : null,
        page.name
      ]
    }
  );
...
function ResizableHandle({
  ...
  return /* @__PURE__ */ jsx(
    PanelResizeHandle,
    {
      ...
      ...props2,
      children: withHandle && /* @__PURE__ */ jsx("div", { className: "bg-border z-10 flex h-4 w-3 items-center justify-center rounded-xs border", children: /* @__PURE__ */ jsx(GripVertical, { className: "size-2.5" }) })
    }
  );
}
      ...
      children: [
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            style,
            children: color.name === colorTheme && /* @__PURE__ */ jsx(Check, { className: "size-4" })
          }
        ),
        color.label
      ]
...
function ThemeModeOption({ modeOption, mode, onClick }) {
  ...
  return /* @__PURE__ */ jsxs(
    Button,
    {
      ...
      size: "sm",
      onClick: handleOnClick,
      className: cn$1(mode === modeOption && "border-2 border-primary"),
      children: [
        modeOption === "light" ? /* @__PURE__ */ jsx(Sun, { className: "mr-1 -translate-x-1" }) : /* @__PURE__ */ jsx(Moon, { className: "mr-1 -translate-x-1" }),
        modeOption
      ]
    },
    modeOption
...
const VariablesPanel = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn$1("flex flex-col gap-4 p-4", className), children: [
...
const VariableCard = ({
  ...
  return /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(CardContent, { className: "pt-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
    ...
    editVariables && /* @__PURE__ */ jsxs("div", { className: "flex gap-1", children: [
      /* @__PURE__ */ jsx(Button, { size: "sm", variant: "ghost", onClick: handleOnEdit, children: /* @__PURE__ */ jsx(Pen, { className: "h-4 w-4" }) }),
