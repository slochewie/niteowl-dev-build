...
import { Y as createKanbanQueryKeys, q as cn$1, l as usePluginOverrides, T as createApiClient } from "./router-qu_5GP1h.mjs";
...
function PageWrapper({
  ...
  return /* @__PURE__ */ jsx("div", { className: cn$1("container mx-auto py-8 px-4", className), ...props, children });
}
export {
  PageWrapper as P,
  useBoardMutations as a,
  useSuspenseBoard as b,
