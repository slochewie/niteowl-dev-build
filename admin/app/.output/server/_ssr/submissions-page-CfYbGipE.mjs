...
import { D as DefaultError } from "./default-error-Dgtv0I0W.mjs";
...
const SubmissionsPage = lazy(
  () => import("./submissions-page.internal-E9cqbAvY.mjs").then((m2) => ({
    default: m2.SubmissionsPage
  }))
);
function SubmissionsPageComponent({ formId }) {
  return /* @__PURE__ */ jsx(m, { FallbackComponent: DefaultError, children: /* @__PURE__ */ jsx(Suspense, { fallback: /* @__PURE__ */ jsx(SubmissionsSkeleton, {}), children: /* @__PURE__ */ jsx(SubmissionsPage, { formId }) }) });
}
export {
