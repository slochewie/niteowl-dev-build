...
import { r as drizzle } from "../_libs/drizzle-orm.mjs";
import { o as object, c as boolean, s as string } from "../_libs/zod.mjs";
...
const getServerQueryClient = reactExports.cache(() => makeQueryClient());
function getOrCreateQueryClient() {
  if (isServer) return getServerQueryClient();
  if (!browserQueryClient) browserQueryClient = makeQueryClient();
  return browserQueryClient;
}
const globalsCss = "/assets/globals-BYHC6_s4.css";
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: "en", suppressHydrationWarning: true, children: [
...
const $$splitComponentImporter$3 = () => import("./route-C2ls9lGl.mjs");
...
const $$splitComponentImporter$2 = () => import("./form-demo._slug-CEwOlFS_.mjs");
const Route$3 = createFileRoute("/form-demo/$slug")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("../_-scKz5xaH.mjs");
...
const $$splitComponentImporter = () => import("./preview._slug-Dn7Kuqp0.mjs");
