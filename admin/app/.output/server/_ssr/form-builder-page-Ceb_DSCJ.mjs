...
const FormBuilderPage = lazy(
  () => import("./form-builder-page.internal-BNfmVpHq.mjs").then((m2) => ({
    default: m2.FormBuilderPage
  }))
);
function FormBuilderPageComponent({ id }) {
  return /* @__PURE__ */ jsx(m, { FallbackComponent: DefaultError, children: /* @__PURE__ */ jsx(Suspense, { fallback: /* @__PURE__ */ jsx(FormBuilderSkeleton, {}), children: /* @__PURE__ */ jsx(FormBuilderPage, { id }) }) });
}
export {
