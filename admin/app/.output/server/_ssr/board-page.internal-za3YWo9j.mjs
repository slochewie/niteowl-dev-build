...
import { l as usePluginOverrides, B as Button, ap as PRIORITY_OPTIONS, q as cn$1, ao as getPriorityConfig } from "./router-qu_5GP1h.mjs";
...
import { D as Dialog, d as DialogContent, a as DialogHeader, b as DialogTitle, c as DialogDescription } from "./dialog-B4u5EdHX.mjs";
...
import { b as useSuspenseBoard, a as useBoardMutations, c as useColumnMutations, d as useTaskMutations, P as PageWrapper, e as useSearchUsers, f as useResolveUser } from "./page-wrapper-D5yp3MTX.mjs";
import { u as useSensors, a as useSensor, c as closestCenter, p as pointerWithin, r as rectIntersection, g as getFirstCollision, D as DndContext, M as MeasuringStrategy, b as DragOverlay, K as KeyboardSensor, T as TouchSensor, d as MouseSensor, e as defaultDropAnimationSideEffects, f as KeyboardCode, h as closestCorners, C as CSS } from "./core.esm-Bjw07ll7.mjs";
import { v as verticalListSortingStrategy, a as arrayMove, S as SortableContext, h as horizontalListSortingStrategy, u as useSortable, d as defaultAnimateLayoutChanges } from "./sortable.esm-Cz_svvTh.mjs";
import { S as Slot } from "../_libs/radix-ui__react-slot.mjs";
import * as ReactDOM from "react-dom";
import { B as Badge } from "./badge-CGoI1f31.mjs";
import { A as Avatar, a as AvatarFallback, b as AvatarImage } from "./avatar-DgTJEQBc.mjs";
...
import { M as MinimalTiptapEditor } from "./minimal-tiptap-C14rUPAr.mjs";
import { P as Popover, a as PopoverTrigger, C as Content2 } from "./popover-I-2hrCQX.mjs";
import { e as Command, a as CommandInput, b as CommandList, c as CommandEmpty, f as CommandGroup, d as CommandItem } from "./command-8DCQ5FSU.mjs";
...
import { A as ArrowLeft, i as Settings, P as Plus, j as Pencil, k as Trash2, a as ChevronDown, f as Check, G as GripVertical, E as EllipsisVertical, l as User } from "../_libs/lucide-react.mjs";
  ...
  return ReactDOM.createPortal(
    /* @__PURE__ */ jsx(
      DragOverlay,
      {
        ...
        className: cn$1(!context.flatCursor && "cursor-grabbing"),
        ...overlayProps,
  ...
  return /* @__PURE__ */ jsxs(KanbanColumn, { value: column.id, children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
      ...
      /* @__PURE__ */ jsxs(DropdownMenu, { children: [
        /* @__PURE__ */ jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsx(Button, { variant: "ghost", size: "icon", children: /* @__PURE__ */ jsx(EllipsisVertical, { className: "h-4 w-4" }) }) }),
  ...
  return /* @__PURE__ */ jsxs(Popover, { open, onOpenChange: setOpen, modal: false, children: [
    /* @__PURE__ */ jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxs(
      Button,
      {
        ...
        children: [
          /* @__PURE__ */ jsx("span", { className: cn$1("truncate", !value && "text-muted-foreground"), children: value ? options.find((option) => option.value === value)?.label : placeholder }),
          /* @__PURE__ */ jsx(
            ChevronDown,
            {
              size: 16,
          ...
          /* @__PURE__ */ jsxs(CommandList, { children: [
            ...
            /* @__PURE__ */ jsx(CommandGroup, { children: options.map((option) => /* @__PURE__ */ jsxs(
              CommandItem,
              {
                ...
                children: [
                  option.label,
                  value === option.value && /* @__PURE__ */ jsx(Check, { size: 16, className: "ml-auto" })
                ]
              },
              option.value
            )) })
