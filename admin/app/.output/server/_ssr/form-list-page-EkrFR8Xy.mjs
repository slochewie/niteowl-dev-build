...
const FormListPage = lazy(
  () => import("./form-list-page.internal-DwmP2P8b.mjs").then((m2) => ({
    default: m2.FormListPage
  }))
);
function FormListPageComponent() {
  return /* @__PURE__ */ jsx(m, { FallbackComponent: DefaultError, children: /* @__PURE__ */ jsx(Suspense, { fallback: /* @__PURE__ */ jsx(FormListSkeleton, {}), children: /* @__PURE__ */ jsx(FormListPage, {}) }) });
}
export {
