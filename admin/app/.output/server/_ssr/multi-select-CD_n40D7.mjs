...
import { _ as _e, P } from "../_libs/cmdk.mjs";
import * as React from "react";
import { useMemo, useEffect, useCallback, forwardRef } from "react";
import { B as Badge } from "./badge-CGoI1f31.mjs";
import { d as CommandItem, e as Command, b as CommandList, f as CommandGroup } from "./command-8DCQ5FSU.mjs";
import { q as cn$1 } from "./router-qu_5GP1h.mjs";
import { u as useDebounce } from "./use-debounce-B6NKG3k-.mjs";
...
const CommandEmpty = forwardRef(({ className, ...props }, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx(
    ...
    {
      ref: forwardedRef,
      className: cn$1("py-6 text-center text-sm", className),
      "cmdk-empty": "",
      role: "presentation",
      ...props
    }
