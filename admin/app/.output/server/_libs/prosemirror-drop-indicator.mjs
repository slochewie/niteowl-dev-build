import { P as Plugin, a as PluginKey, N as NodeSelection, T as TextSelection } from "./prosemirror-state.mjs";
import { i as isHTMLElement } from "./ocavue__utils.mjs";
...
function buildGetTarget(view, onDrag) {
  ...
  const getTargetImpl = (point, event) => {
    ...
    const target = targets.find((target2) => onDrag?.({
      view,
      pos: target2[0],
      event
    }) !== false);
...
export {
  createDropIndicatorPlugin as c
};
