import { j as remarkStringifyOptionsCtx, c as commandsCtx, e as editorViewCtx } from "./milkdown__core.mjs";
import { m as markRule, a as findSelectedNodeOfType, d as findNodeInSelection } from "./milkdown__prose.mjs";
import { f as $inputRule, b as $command, g as $node, h as $nodeAttr, d as $nodeSchema, $ as $ctx, i as $markAttr, j as $markSchema, k as $useKeymap, a as $prose, c as $remark } from "./milkdown__utils.mjs";
import { i as expectDomTypeError } from "./milkdown__exception.mjs";
import { t as toggleMark, a as setBlockType, w as wrapIn, f as joinBackward } from "./prosemirror-commands.mjs";
import { T as TextSelection, S as Selection, P as Plugin, a as PluginKey } from "./prosemirror-state.mjs";
import { t as textblockTypeInputRule, w as wrappingInputRule, I as InputRule } from "./prosemirror-inputrules.mjs";
import { s as sinkListItem, l as liftListItem, a as splitListItem } from "./prosemirror-schema-list.mjs";
import { f as findWrapping, R as ReplaceStep, A as AddMarkStep } from "./prosemirror-transform.mjs";
import { N as Node, F as Fragment } from "./prosemirror-model.mjs";
import { v as visit } from "./unist-util-visit.mjs";
import { r as remarkInlineLinks } from "./remark-inline-links.mjs";
import { a as Decoration, D as DecorationSet } from "./prosemirror-view.mjs";
...
var strongInputRule = $inputRule((ctx) => {
  return markRule(new RegExp("(?<![\\w:/])(?:\\*\\*|__)([^*_]+?)(?:\\*\\*|__)(?![\\w/])$"), strongSchema.type(ctx), { getAttr: (match) => {
        ...
        if (base?.type === listItemType && base.attrs.listType === "ordered") {
          ...
          node.descendants((child, pos2, _parent, index2) => {
            if (child.type === listItemType) {
              ...
              if (handleNodeItem(attrs, index2)) tr = tr.setNodeMarkup(pos2, void 0, attrs);
            }
            return false;
          });
        }
...
export {
  listItemSchema as a,
  commonmark as b,
  codeBlockSchema as c,
  strongSchema as d,
  toggleEmphasisCommand as e,
  emphasisSchema as f,
  inlineCodeSchema as g,
  toggleInlineCodeCommand as h,
  imageSchema as i,
  bulletListSchema as j,
  addBlockTypeCommand as k,
  linkSchema as l,
  selectTextNearPosCommand as m,
  setBlockTypeCommand as n,
  orderedListSchema as o,
  paragraphSchema as p,
  blockquoteSchema as q,
  hrSchema as r,
  sanitizeLinkHref as s,
  toggleStrongCommand as t,
  isMarkSelectedCommand as u,
  isNodeSelectedCommand as v,
  wrapInBlockTypeCommand as w,
  clearTextInCurrentBlockCommand as x,
  headingSchema as y
};
