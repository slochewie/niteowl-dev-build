import { i as isNodeProcess } from "./is-node-process.mjs";
import { i as isBuffer } from "./is-buffer.mjs";
import { Readable } from "stream";
import { d as distExports } from "./vercel__oidc.mjs";
import { r as retry } from "./async-retry.mjs";
import { u as undiciExports } from "./undici.mjs";
import { t as throttle2 } from "./throttleit.mjs";
import "./react.mjs";
import "./jose.mjs";
import "node:buffer";
import "node:util";
...
import "node:http";
import "node:https";
import "./@vercel/cli-config.mjs";
import "node:os";
import "./zod.mjs";
import "node:fs";
import "node:path";
import "./xdg-app-paths.mjs";
import "path";
import "./xdg-portable.mjs";
import "./os-paths.mjs";
import "os";
import "fs";
import "./@vercel/cli-exec.mjs";
import "node:fs/promises";
import "./execa.mjs";
import "child_process";
import "./cross-spawn.mjs";
import "./which.mjs";
import "./isexe.mjs";
import "./path-key.mjs";
import "./shebang-command.mjs";
import "./shebang-regex.mjs";
import "./strip-final-newline.mjs";
import "./npm-run-path.mjs";
import "./onetime.mjs";
import "./mimic-fn.mjs";
import "./human-signals.mjs";
import "./signal-exit.mjs";
import "assert";
import "events";
import "./is-stream.mjs";
import "./get-stream.mjs";
import "buffer";
import "util";
import "./merge-stream.mjs";
import "./retry.mjs";
import "node:assert";
import "node:net";
...
async function getVercelOidcToken() {
  try {
    const token = (await distExports.getVercelOidcToken()).trim();
...
var hasFetch = typeof undiciExports.fetch === "function";
...
async function retrieveClientToken(options) {
  ...
  const res = await undiciExports.fetch(url, {
    method: "POST",
