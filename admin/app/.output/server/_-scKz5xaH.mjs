...
import { a as Route$2, g as getOrCreateQueryClient, b as getStackClient } from "./_ssr/router-IZBe-lk7.mjs";
import "./_libs/pg.mjs";
...
function BtstPagesRoute() {
  ...
  return route?.PageComponent ? /* @__PURE__ */ jsxRuntimeExports.jsx(route.PageComponent, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Route not found" });
}
export {
