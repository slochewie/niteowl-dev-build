...
import { C as Checkbox, T as Textarea, u as useCaptcha, a as Captcha, P as PasswordInput, s as socialProviders } from "./chunk-2FH7HU2O-MYBnhmp_.js";
import { L as Label2, D as DropdownMenu, a as DropdownMenuTrigger, U as UserAvatar, b as DropdownMenuContent, c as DropdownMenuItem, F as Form, d as FormField, e as FormItem, f as FormControl, I as Input, g as FormMessage, h as FormLabel, r as resizeAndCropImage, i as fileToBase64 } from "./chunk-52PGTSBA-DxrPz66P.js";
import { u as useAuthenticate, O as OrganizationCellView, a as OrganizationLogo } from "./chunk-XPGLXIJB-gK-XK5gU.js";
import { A as AuthUIContext, u as useIsHydrated, a as useLang } from "./chunk-EIO6LPR6-BfBdj5c5.js";
import { g as getViewByPath, B as Button, c as cn, C as CardContent, a as Card, S as Skeleton, b as getPasswordSchema, d as getLocalizedError } from "./chunk-KS7QMNEN-DP7ssmzE.js";
import { zodResolver } from "@hookform/resolvers/zod";
import { MenuIcon, UploadCloudIcon, Trash2Icon, UsersIcon, Loader2, EllipsisIcon, SettingsIcon, LogOutIcon, CheckIcon, XIcon, RepeatIcon, UserX2Icon, FingerprintIcon, SmartphoneIcon, LaptopIcon, CopyIcon } from "lucide-react";
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
                  ...
                  /* @__PURE__ */ jsxs(
                    Button,
                    {
                      ...
                      type: "button",
                      children: [
                        logoPending && /* @__PURE__ */ jsx(Loader2, { className: "animate-spin" }),
                        localization.UPLOAD
                      ]
                    }
                  )
        ...
        /* @__PURE__ */ jsxs(DropdownMenuContent, { children: [
          /* @__PURE__ */ jsxs(
            DropdownMenuItem,
            {
              ...
              disabled: isManagingOrganization,
              children: [
                /* @__PURE__ */ jsx(SettingsIcon, { className: classNames == null ? void 0 : classNames.icon }),
          ...
          /* @__PURE__ */ jsxs(
            DropdownMenuItem,
            {
              ...
              variant: "destructive",
              children: [
                /* @__PURE__ */ jsx(LogOutIcon, { className: classNames == null ? void 0 : classNames.icon }),
          ...
          children: [
            /* @__PURE__ */ jsxs(
              DropdownMenuItem,
              {
                ...
                disabled: isLoading,
                children: [
                  /* @__PURE__ */ jsx(CheckIcon, { className: classNames == null ? void 0 : classNames.icon }),
                  localization.ACCEPT
                ]
              }
            ),
    ...
    /* @__PURE__ */ jsxs(DropdownMenu, { children: [
      ...
      /* @__PURE__ */ jsxs(DropdownMenuContent, { children: [
        !isCurrentSession && /* @__PURE__ */ jsxs(DropdownMenuItem, { onClick: handleSetActiveSession, children: [
          /* @__PURE__ */ jsx(RepeatIcon, { className: classNames == null ? void 0 : classNames.icon }),
        ...
        /* @__PURE__ */ jsxs(
          DropdownMenuItem,
          {
            ...
            variant: "destructive",
            children: [
              isCurrentSession ? /* @__PURE__ */ jsx(LogOutIcon, { className: classNames == null ? void 0 : classNames.icon }) : /* @__PURE__ */ jsx(UserX2Icon, { className: classNames == null ? void 0 : classNames.icon }),
...
function UpdateFieldCard({
  ...
  if (type === "number") {
    fieldSchema = required ? z.preprocess(
    ...
    fieldSchema = required ? z.coerce.boolean({
      message: (errorMessage == null ? void 0 : errorMessage.invalid) ?? `${label} ${localization.IS_INVALID}`
    }).refine((val) => val === true, {
    ...
    fieldSchema = required ? z.string().min(
      1,
...
function DeleteAccountDialog({
  ...
  const formSchema = z.object({
    password: credentialsLinked ? z.string().min(1, { message: localization.PASSWORD_REQUIRED }) : z.string().optional()
  });
  const form = useForm({
    resolver: zodResolver(formSchema),
    defaultValues: {
          ...
          /* @__PURE__ */ jsx(
            Button,
            {
              ...
              children: copied ? /* @__PURE__ */ jsxs(Fragment, { children: [
                ...
                /* @__PURE__ */ jsx(CopyIcon, { className: classNames == null ? void 0 : classNames.icon }),
