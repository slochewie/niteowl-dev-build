import { createRootRouteWithContext, HeadContent, Outlet, Scripts, createFileRoute, lazyRouteComponent, notFound, createRouter as createRouter$2 } from "@tanstack/react-router";
import { setupRouterSsrQueryIntegration } from "@tanstack/react-router-ssr-query";
import { cache, createContext, useContext, Suspense, lazy } from "react";
import { jsxs, jsx, Fragment } from "react/jsx-runtime";
import { createRouter, createRoute } from "@btst/yar";
import { createClient } from "better-call/client";
import * as z from "zod";
import { z as z$1 } from "zod";
import { CloudAlert, AlertCircle, RefreshCw, Loader2 } from "lucide-react";
...
import { createRouter as createRouter$1, createEndpoint } from "better-call";
...
const $$splitComponentImporter$4 = () => import("./index-BfsVN3JM.js");
const Route$b = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./route-CppFNsRe.js");
...
const HomePage = lazy(
  () => import("./home-page.internal-zfn1NySZ.js").then((m) => ({ default: m.HomePage }))
);
...
const NewPostPage = lazy(
  () => import("./new-post-page.internal-BFbowB5Q.js").then((m) => ({ default: m.NewPostPage }))
);
...
const EditPostPage = lazy(
  () => import("./edit-post-page.internal-CXLtZBgM.js").then((m) => ({
...
const TagPage = lazy(
  () => import("./tag-page.internal-D8jsKWoD.js").then((m) => ({ default: m.TagPage }))
);
...
const PostPage = lazy(
  () => import("./post-page.internal-BL6Lh5Bo.js").then((m) => ({ default: m.PostPage }))
);
...
const DashboardPageComponent = lazy(
  () => import("./dashboard-page-DKgfHSZu.js").then((m) => ({
    default: m.DashboardPageComponent
  }))
);
const ContentListPageComponent = lazy(
  () => import("./content-list-page-CMMD25ZB.js").then((m) => ({
    default: m.ContentListPageComponent
  }))
);
const ContentEditorPageComponent = lazy(
  () => import("./content-editor-page-CmFRCAlQ.js").then((n) => n.c).then((m) => ({
...
function zodToFormSchema(schema2, metadata) {
  const jsonSchema = z$1.toJSONSchema(schema2, {
    unrepresentable: "any",
    override: (ctx) => {
...
function formSchemaToZod(jsonSchema) {
  let schema2 = z$1.fromJSONSchema(jsonSchema);
...
const uiBuilderPageSchema = z$1.object({
  /** JSON-serialized ComponentLayer[] representing the page structure */
  layers: z$1.string().meta({ fieldType: "textarea" }),
  /** JSON-serialized Variable[] for dynamic content */
  variables: z$1.string().default("[]").meta({ fieldType: "textarea" }),
  /** Page publication status */
  status: z$1.enum(["published", "draft", "archived"]).default("draft").meta({ fieldType: "select" })
});
...
const PageListPageComponent = lazy(
  () => import("./page-list-page-DNPLjHBX.js").then((n) => n.p).then((m) => ({
    default: m.PageListPage
  }))
);
const PageBuilderPageComponent = lazy(
  () => import("./page-builder-page-BT7SEIZ7.js").then((m) => ({
...
const BoardsListPage = lazy(
  () => import("./boards-list-page.internal-VJ771-HK.js").then((m) => ({
...
const NewBoardPage = lazy(
  () => import("./new-board-page.internal-uOFic4yG.js").then((m) => ({
...
const BoardPage = lazy(
  () => import("./board-page.internal-8Qh3CevH.js").then((m) => ({
    default: m.BoardPage
  }))
);
...
const ModerationPageComponent = lazy(
  () => import("./moderation-page-DThrqGff.js").then((m) => ({
    default: m.ModerationPageComponent
  }))
);
const UserCommentsPageComponent = lazy(
  () => import("./my-comments-page-K6faZW-j.js").then((m) => ({
...
const LibraryPage = lazy(
  () => import("./library-page.internal-Bor6Sjg6.js").then((m) => ({ default: m.LibraryPage }))
);
    ...
    accountSettings: createRoute(
      ...
      () => {
        const AccountSettingsPage = lazy(
          () => import("./account-settings-page-TQ7GKK73-Bzpaxkr4.js").then((m) => ({
    ...
    accountSecurity: createRoute(
      ...
      () => {
        const AccountSecurityPage = lazy(
          () => import("./account-security-page-VXPA2HTK--F0Frh0R.js").then((m) => ({
    ...
    accountApiKeys: createRoute(
      ...
      () => {
        const AccountApiKeysPage = lazy(
          () => import("./account-api-keys-page-ML6QV7K4-CZ4nmSHD.js").then((m) => ({
    ...
    accountOrganizations: createRoute(
      ...
      () => {
        const AccountOrganizationsPage = lazy(
          () => import("./account-organizations-page-LO4AWXYO-DisNsfa3.js").then((m) => ({
    ...
    accountTeams: createRoute(
      ...
      () => {
        const AccountTeamsPage = lazy(
          () => import("./account-teams-page-YXHGA6DU-DgriH4jW.js").then((m) => ({
  ...
  routes: () => ({
    signIn: createRoute(`/auth/${authViewPaths.SIGN_IN}`, () => {
      const SignInPage = lazy(
        () => import("./sign-in-page-5LRHUH6V-cZo-GDtr.js").then(
          (m) => ({
    ...
    signUp: createRoute(`/auth/${authViewPaths.SIGN_UP}`, () => {
      const SignUpPage = lazy(
        () => import("./sign-up-page-5PRZNHPF-CgBFzBwd.js").then(
          (m) => ({
    ...
    forgotPassword: createRoute(
      ...
      () => {
        const ForgotPasswordPage = lazy(
          () => import("./forgot-password-page-QW45562I-bhVsittz.js").then((m) => ({
    ...
    resetPassword: createRoute(
      ...
      () => {
        const ResetPasswordPage = lazy(
          () => import("./reset-password-page-LCLD4DOW-BeD2azSq.js").then((m) => ({
    ...
    magicLink: createRoute(`/auth/${authViewPaths.MAGIC_LINK}`, () => {
      const MagicLinkPage = lazy(
        () => import("./magic-link-page-5AKSRKRN-CxhBFTxl.js").then(
          (m) => ({
    ...
    emailOtp: createRoute(`/auth/${authViewPaths.EMAIL_OTP}`, () => {
      const EmailOtpPage = lazy(
        () => import("./email-otp-page-C6PVS4I7-DIYlMBvh.js").then(
          (m) => ({
    ...
    twoFactor: createRoute(`/auth/${authViewPaths.TWO_FACTOR}`, () => {
      const TwoFactorPage = lazy(
        () => import("./two-factor-page-G7UY27TG-z_JB-wz0.js").then(
          (m) => ({
    ...
    recoverAccount: createRoute(
      ...
      () => {
        const RecoverAccountPage = lazy(
          () => import("./recover-account-page-YTEGVO7U-BmMvkUbG.js").then((m) => ({
    ...
    callback: createRoute(`/auth/${authViewPaths.CALLBACK}`, () => {
      const CallbackPage = lazy(
        () => import("./callback-page-TF3J2VMN-CWu0X8mP.js").then(
          (m) => ({
    ...
    signOut: createRoute(`/auth/${authViewPaths.SIGN_OUT}`, () => {
      const SignOutPage = lazy(
        () => import("./sign-out-page-YWHTKNFE-DffXW27u.js").then(
          (m) => ({
    ...
    acceptInvitation: createRoute(
      ...
      () => {
        const AcceptInvitationPage = lazy(
          () => import("./accept-invitation-page-GMSN3A3H-Da7fP77X.js").then((m) => ({
    ...
    emailVerification: createRoute(
      ...
      () => {
        const EmailVerificationPage = lazy(
          () => import("./email-verification-page-DSGCQ3FU-czBOOWdB.js").then((m) => ({
    ...
    organizationSettings: createRoute(
      ...
      () => {
        const OrganizationSettingsPage = lazy(
          () => import("./organization-settings-page-DOCNYJET-Cn77vgDH.js").then((m) => ({
    ...
    organizationMembers: createRoute(
      ...
      () => {
        const OrganizationMembersPage = lazy(
          () => import("./organization-members-page-2ZYAVV45-BmL912cl.js").then((m) => ({
    ...
    organizationApiKeys: createRoute(
      ...
      () => {
        const OrganizationApiKeysPage = lazy(
          () => import("./organization-api-keys-page-4MEQXR25-CP_Folv1.js").then((m) => ({
    ...
    organizationTeams: createRoute(
      ...
      () => {
        const OrganizationTeamsPage = lazy(
          () => import("./organization-teams-page-B3PZGE5L-BcRdNX3_.js").then((m) => ({
...
const DocsPageComponent = lazy(
  () => import("./docs-page-Da1gTyH2.js").then((m) => ({
    default: m.DocsPageComponent
  }))
);
const DocsPageSkeleton = lazy(
  () => import("./docs-skeleton-CBr6QlrF.js").then((m) => ({
...
const dateFields = {
  publishedAt: z$1.coerce.date().optional(),
  createdAt: z$1.coerce.date().optional(),
  updatedAt: z$1.coerce.date().optional()
};
const coreFields = {
  title: z$1.string().min(1, "Title is required"),
  content: z$1.string().min(1, "Content is required"),
  excerpt: z$1.string().min(1, "Excerpt is required"),
  image: z$1.string().optional(),
  published: z$1.boolean().optional().default(false),
  slug: z$1.string().min(1, "Slug is required"),
  tags: z$1.array(
    z$1.union([
      z$1.object({ name: z$1.string() }),
      z$1.object({ id: z$1.string(), name: z$1.string(), slug: z$1.string() })
    ])
  ).optional().default([])
};
const PostDomainSchema = z$1.object({
...
const NextPreviousPostsQuerySchema = z$1.object({
  date: z$1.coerce.date()
});
...
function createListContentQuerySchema(maxPageSize = DEFAULT_MAX_PAGE_SIZE) {
  return z$1.object({
    slug: z$1.string().optional(),
    limit: z$1.coerce.number().min(1).max(maxPageSize).optional().default(20),
    offset: z$1.coerce.number().min(0).optional().default(0)
  });
}
...
z$1.object({
  ...
  data: z$1.object({}).passthrough()
});
z$1.object({
  slug: z$1.string().min(1, "Slug is required").optional(),
  // Use passthrough object instead of z.record(z.unknown()) due to Zod v4 bug
  data: z$1.object({}).passthrough().optional()
});
const contentTypeResponseSchema = z$1.object({
  id: z$1.string(),
  name: z$1.string(),
  slug: z$1.string(),
  description: z$1.string().nullable().optional(),
  jsonSchema: z$1.string(),
  createdAt: z$1.string(),
  updatedAt: z$1.string()
});
const contentItemResponseSchema = z$1.object({
  id: z$1.string(),
  contentTypeId: z$1.string(),
  slug: z$1.string(),
  data: z$1.string(),
  authorId: z$1.string().nullable().optional(),
  createdAt: z$1.string(),
  updatedAt: z$1.string()
});
const contentItemWithDataResponseSchema = contentItemResponseSchema.extend({
  // Use passthrough object instead of z.record(z.unknown()) due to Zod v4 bug
  parsedData: z$1.object({}).passthrough(),
  contentType: contentTypeResponseSchema.optional()
});
z$1.object({
  items: z$1.array(contentItemWithDataResponseSchema),
  total: z$1.number(),
  limit: z$1.number(),
  offset: z$1.number()
});
...
const cmsBackendPlugin = (config) => {
  ...
  return defineBackendPlugin({
    ...
    routes: (adapter) => {
      ...
      const paginationQuerySchema = z$1.object({
        limit: z$1.coerce.number().min(1).max(config.maxPageSize ?? DEFAULT_MAX_PAGE_SIZE).optional().default(20),
        offset: z$1.coerce.number().min(0).optional().default(0)
      });
      ...
      const getContentTypeBySlug = createEndpoint(
        ...
        {
          method: "GET",
          params: z$1.object({ slug: z$1.string() })
        },
        async (ctx) => {
      ...
      const listContentItems = createEndpoint(
        ...
        {
          method: "GET",
          params: z$1.object({ typeSlug: z$1.string() }),
      ...
      const getContentItem = createEndpoint(
        ...
        {
          method: "GET",
          params: z$1.object({ typeSlug: z$1.string(), id: z$1.string() })
        },
        async (ctx) => {
...
const listFormsQuerySchema = z$1.object({
  status: z$1.enum(["active", "inactive", "archived"]).optional(),
  limit: z$1.coerce.number().min(1).max(100).optional().default(20),
  offset: z$1.coerce.number().min(0).optional().default(0)
});
const createFormSchema = z$1.object({
  name: z$1.string().min(1, "Name is required"),
  slug: z$1.string().min(1, "Slug is required"),
  description: z$1.string().optional(),
  schema: z$1.string().min(1, "Schema is required"),
  successMessage: z$1.string().optional(),
  redirectUrl: z$1.string().url().optional().or(z$1.literal("")),
  status: z$1.enum(["active", "inactive", "archived"]).optional().default("active")
});
const updateFormSchema = z$1.object({
  name: z$1.string().min(1, "Name is required").optional(),
  slug: z$1.string().min(1, "Slug is required").optional(),
  description: z$1.string().optional(),
  schema: z$1.string().min(1, "Schema is required").optional(),
  successMessage: z$1.string().optional(),
  redirectUrl: z$1.string().url().optional().or(z$1.literal("")),
  status: z$1.enum(["active", "inactive", "archived"]).optional()
});
const formResponseSchema = z$1.object({
  id: z$1.string(),
  name: z$1.string(),
  slug: z$1.string(),
  description: z$1.string().nullable().optional(),
  schema: z$1.string(),
  successMessage: z$1.string().nullable().optional(),
  redirectUrl: z$1.string().nullable().optional(),
  status: z$1.string(),
  createdBy: z$1.string().nullable().optional(),
  createdAt: z$1.string(),
  updatedAt: z$1.string()
});
z$1.object({
  items: z$1.array(formResponseSchema),
  total: z$1.number(),
  limit: z$1.number(),
  offset: z$1.number()
});
const listSubmissionsQuerySchema = z$1.object({
  limit: z$1.coerce.number().min(1).max(100).optional().default(20),
  offset: z$1.coerce.number().min(0).optional().default(0)
});
z$1.object({
...
const formSubmissionResponseSchema = z$1.object({
  id: z$1.string(),
  formId: z$1.string(),
  data: z$1.string(),
  submittedAt: z$1.string(),
  submittedBy: z$1.string().nullable().optional(),
  ipAddress: z$1.string().nullable().optional(),
  userAgent: z$1.string().nullable().optional()
});
...
z$1.object({
  items: z$1.array(formSubmissionWithDataResponseSchema),
  total: z$1.number(),
  limit: z$1.number(),
  offset: z$1.number()
});
...
const formBuilderBackendPlugin = (config = {}) => defineBackendPlugin({
  ...
  routes: (adapter) => {
    ...
    const listSubmissions = createEndpoint(
      ...
      {
        method: "GET",
        params: z$1.object({ formId: z$1.string() }),
    ...
    const getSubmission = createEndpoint(
      ...
      {
        method: "GET",
        params: z$1.object({ formId: z$1.string(), subId: z$1.string() })
      },
      async (ctx) => {
...
const PrioritySchema = z$1.enum(["LOW", "MEDIUM", "HIGH", "URGENT"]);
...
const BoardDomainSchema = z$1.object({
  id: z$1.string().optional(),
  ...boardCoreFields,
  ...boardDateFields
});
...
const columnCoreFields = {
  title: z$1.string().min(1, "Title is required"),
  order: z$1.number().int().min(0).optional().default(0),
  boardId: z$1.string().min(1, "Board ID is required")
};
const ColumnDomainSchema = z$1.object({
  id: z$1.string().optional(),
  ...columnCoreFields,
  ...columnDateFields
});
...
const taskCoreFields = {
  ...
  order: z$1.number().int().min(0).optional().default(0),
  columnId: z$1.string().min(1, "Column ID is required"),
  assigneeId: z$1.string().optional().nullable(),
  isArchived: z$1.boolean().optional().default(false)
};
const TaskDomainSchema = z$1.object({
  id: z$1.string().optional(),
  ...taskCoreFields,
  ...taskDateFields
});
...
const BoardListQuerySchema = z$1.object({
  slug: z$1.string().optional(),
  ownerId: z$1.string().optional(),
  organizationId: z$1.string().optional(),
  offset: z$1.coerce.number().int().min(0).optional(),
...
z$1.object({
  boardId: z$1.string().optional()
});
z$1.object({
  columnId: z$1.string().optional(),
  assigneeId: z$1.string().optional(),
  priority: PrioritySchema.optional(),
  isArchived: z$1.string().optional().transform((val) => {
    if (val === void 0) return void 0;
    if (val === "true") return true;
    if (val === "false") return false;
    return void 0;
...
const reorderColumnsSchema = z$1.object({
  boardId: z$1.string().min(1, "Board ID is required"),
  columnIds: z$1.array(z$1.string()).min(1, "Column IDs are required")
});
const reorderTasksSchema = z$1.object({
  columnId: z$1.string().min(1, "Column ID is required"),
  taskIds: z$1.array(z$1.string()).min(1, "Task IDs are required")
});
const moveTaskSchema = z$1.object({
  taskId: z$1.string().min(1, "Task ID is required"),
  targetColumnId: z$1.string().min(1, "Target column ID is required"),
  targetOrder: z$1.number().int().min(0)
});
...
const CommentStatusSchema = z$1.enum(["pending", "approved", "spam"]);
const createCommentSchema = z$1.object({
  resourceId: z$1.string().min(1, "Resource ID is required"),
  resourceType: z$1.string().min(1, "Resource type is required"),
  parentId: z$1.string().optional().nullable(),
  body: z$1.string().min(1, "Body is required").max(1e4, "Comment too long")
});
createCommentSchema.extend({
  authorId: z$1.string().min(1, "Author ID is required")
});
const updateCommentSchema = z$1.object({
  body: z$1.string().min(1, "Body is required").max(1e4, "Comment too long")
});
const updateCommentStatusSchema = z$1.object({
  status: CommentStatusSchema
});
const CommentListQuerySchema = z$1.object({
  resourceId: z$1.string().optional(),
  resourceType: z$1.string().optional(),
  parentId: z$1.string().optional().nullable(),
  status: CommentStatusSchema.optional(),
  authorId: z$1.string().optional(),
  sort: z$1.enum(["asc", "desc"]).optional(),
  limit: z$1.coerce.number().int().min(1).max(100).optional(),
  offset: z$1.coerce.number().int().min(0).optional()
});
CommentListQuerySchema.extend({
  currentUserId: z$1.string().optional()
});
const CommentCountQuerySchema = z$1.object({
  resourceId: z$1.string().min(1),
  resourceType: z$1.string().min(1),
  status: CommentStatusSchema.optional()
});
  ...
  return defineBackendPlugin({
    ...
    routes: (adapter) => {
      ...
      const toggleLikeEndpoint = createEndpoint(
        ...
        {
          method: "POST",
          body: z$1.object({ authorId: z$1.string().min(1) })
        },
        async (ctx) => {
          const { id } = ctx.params;
          const context = {
...
const AssetListQuerySchema = z$1.object({
  folderId: z$1.string().optional(),
  mimeType: z$1.string().optional(),
  query: z$1.string().optional(),
  offset: z$1.coerce.number().int().min(0).optional(),
  limit: z$1.coerce.number().int().min(1).max(100).optional()
});
const createAssetSchema = z$1.object({
  filename: z$1.string().min(1),
  originalName: z$1.string().min(1),
  mimeType: z$1.string().min(1),
...
const updateAssetSchema = z$1.object({
  alt: z$1.string().optional(),
  folderId: z$1.string().nullable().optional()
});
const createFolderSchema = z$1.object({
  name: z$1.string().min(1),
  parentId: z$1.string().optional()
});
const uploadTokenRequestSchema = z$1.object({
  filename: z$1.string().min(1),
  mimeType: z$1.string().min(1),
  size: z$1.number().int().positive(),
  folderId: z$1.string().optional()
});
  ...
  plugins: {
    ...
    cms: cmsBackendPlugin({ contentTypes: [{
      ...
      schema: z$1.object({
        ...
        summary: z$1.string(),
        body: z$1.string(),
        publishedAt: z$1.string(),
        published: z$1.boolean()
      })
  ...
  server: {
    handlers: {
      GET: async () => {
        ...
        try {
          const result = await (async () => {
            const { findOrCreateKanbanBoard: findOrCreateKanbanBoard2, getKanbanColumnsByBoardId: getKanbanColumnsByBoardId2, createKanbanTask: createKanbanTask2 } = await import("./index-DmGfnwL3.js");
            const adapter = myStack.adapter;
  ...
  server: {
    handlers: {
      GET: async () => {
        ...
        try {
          const result = await (async () => {
            const { UI_BUILDER_TYPE_SLUG: UI_BUILDER_TYPE_SLUG2 } = await import("./index-DBV0UjEQ.js");
            const api = myStack.api;
...
const $$splitComponentImporter$2 = () => import("./form-demo._slug-C_P1pOkW.js");
const Route$3 = createFileRoute("/form-demo/$slug")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./_-Rouvm3eP.js");
...
const $$splitComponentImporter = () => import("./preview._slug-Ct033Ib2.js");
