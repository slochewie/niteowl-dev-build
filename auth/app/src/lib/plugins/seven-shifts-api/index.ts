...
const assignLocationBodySchema =
  z.object({
    sourceId:
      z.string().min(1),
...
function apiErrorMessage(
  ...
  if (
    ...
    return (
      `7shifts API returned HTTP ${error.status}`
    )
  }
  ...
  return (
    "Unable to communicate with 7shifts"
  )
}
...
function usernameBaseFromEmail(
  email: string
) {
  const local =
    email
            ...
            try {
              ...
              if (
                ...
                return ctx.json(
                  {
                    error:
                      `A 7shifts API Source named "${name}" already exists`
                  },
                  {
                    status:
                      409
        ...
        createAuthEndpoint(
          ...
          async (ctx) => {
            ...
            try {
              ...
              const companies =
                await listSevenShiftsCompanies({
                  accessToken,
                  apiVersion:
                    source.apiVersion
                })
              ...
              if (
                ...
                return ctx.json(
                  {
                    error:
                      `Expected exactly one 7shifts company, found ${companies.length}`
                  },
                  {
                    status:
                      400
          ...
          async (ctx) => {
            ...
            if (
              ...
              return ctx.json(
                {
                  error:
                    "Test this API Source before loading locations"
                },
                {
                  status:
                    400
        ...
        async (ctx) => {
          ...
          if (
            ...
            return ctx.json(
              {
                error:
                  "Test this API Source before previewing synchronization"
              },
              {
                status:
                  400
        ...
        async (ctx) => {
          ...
          if (
            ...
            return ctx.json(
              {
                error:
                  "Test this API Source before synchronizing"
              },
              {
                status:
                  400
          ...
          if (
            ...
            return ctx.json(
              {
                error:
                  "No enabled organizations are mapped to this API Source"
              },
              {
                status:
                  400
          ...
          try {
              ...
              await mapWithConcurrency({
                ...
                mapper:
                  async (
                    ...
                    user,
                    assignments:
                      await listSevenShiftsUserRoleAssignments({
                        accessToken,
                        companyId:
                          source.companyId!,
                        userId:
            ...
            for (
              ...
              internalLocationBySevenShiftsId.set(
                location.id,
                result.rows[0]
              )
            }
            ...
            const internalDepartmentBySevenShiftsId =
              new Map<
                number,
                string
              >()
            ...
            for (
              const department
              of mappedDepartments
            ) {
              const location =
                internalLocationBySevenShiftsId.get(
                  department.location_id
                )
            ...
            const internalRoleBySevenShiftsId =
              new Map<
                number,
                {
                  id: string
            ...
            for (
              ...
              const departmentId =
                internalDepartmentBySevenShiftsId.get(
                  role.department_id
                ) ??
                null
              ...
              internalRoleBySevenShiftsId.set(
                role.id,
                result.rows[0]
              )
            }

            const currentlyMappedUserIds =
              new Set<number>()
            ...
            const targetInternalLocationIds =
              [
                ...internalLocationBySevenShiftsId
                  .values()
              ].map(
                (location) =>
                  location.id
            ...
            const managedUserIds =
              new Set(
                currentlyMappedUserIds
              )

            for (
              const row
              of previouslyManaged.rows
            ) {
              if (
            ...
            let skippedWithoutEmail =
              0

            let membershipsCreated =
              0

            let assignmentsCreated =
              0
            ...
            for (
              ...
              const existingEmployeeBySevenShiftsId =
                await pool.query<{
                  id: string
                  userId: string
                  mustChangePassword:
              ...
              if (
                existingEmployeeBySevenShiftsId.rowCount ===
                1
              ) {
                employeeRecordId =
                  existingEmployeeBySevenShiftsId
                    .rows[0]
                    .id
                ...
                if (
                  ...
                  if (
                    existingEmployeeByUser.rowCount ===
                    1
                  ) {
                    employeeRecordId =
                      existingEmployeeByUser
                        .rows[0]
                        .id
                  } else {
                    employeeRecordId =
...
const userAssignments =
              ...
              if (!created) {
                ...
                if (
                  ...
                  throw new Error(
                    `Better Auth user ${userId} was not found`
                  )
                }
            ...
            for (
              ...
              for (
                ...
                const role =
                  internalRoleBySevenShiftsId.get(
                    assignment.role_id
                  )
                ...
                const membershipKey =
                  `${location.organizationId}\u0000${employee.userId}`
                ...
                const key =
                  `${employee.employeeRecordId}\u0000${location.id}\u0000${role.id}`
            ...
            for (
              ...
              const key =
                `${assignment.employeeId}\u0000${assignment.locationId}\u0000${assignment.roleId}`
          ...
          async (ctx) => {
            ...
            if (
              ...
              return ctx.json(
                {
                  error:
                    "Test this API Source before assigning locations"
                },
                {
                  status:
                    400
            ...
            try {
              ...
              if (!location) {
                return ctx.json(
                  {
                    error:
                      "7shifts location was not found in this API Source"
                  },
                  {
                    status:
                      400
